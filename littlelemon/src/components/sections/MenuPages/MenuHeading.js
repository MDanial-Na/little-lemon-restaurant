    ...
    return (
        <section className="specials">
            ...
            <section className="specials-cards">
                <MenuCard image={Bakedchicken} name="Baked Chicken" price="$19.99" description="Tender, herb-marinated chicken baked to golden perfection, served with roasted vegetables and creamy mashed potatoes. A savory delight!."/>
                <MenuCard image={Bruschetta} name="Bruschetta" price="$15.99" description="Toasted bread, topped with tomato, prosciutto, and cheese. Seasoned with
                 salt and olive oil."/>
                <MenuCard image={Chickensoup} name="Chicken Soup" price="$15.50" description="Warm, flavorful broth with tender chicken, fresh vegetables, and aromatic herbs. Comfort in a bowl!"/>
                <MenuCard image={Chocolatelavacake} name="Chocolate Lava Cake" price="$15.99" description="Warm, rich chocolate cake with a gooey molten center. Decadent and irresistible!"/>
                ...
                <MenuCard image={Greeksalad} name="Greek Salad" price="$19.99" description="Crisp cucumbers, juicy tomatoes, olives, and feta cheese. Fresh and vibrant!"/>
                <MenuCard image={Lasagna} name="Lasagna" price="$19.99" description="Layers of rich meat sauce, creamy béchamel, and melted cheese. Hearty and satisfying!"/>
                ...
                <MenuCard image={Prosciutto} name="Prosciutto" price="$19.99" description="Thinly sliced, dry-cured Italian ham. Delicate, salty, and savory!"/>
                <MenuCard image={Risotto} name="Risotto" price="$19.99" description="Creamy Arborio rice cooked with broth, Parmesan, and a touch of white wine. Rich and comforting!"/>
                ...
                <MenuCard image={Steak} name="Steak" price="$30.99" description="Juicy, perfectly grilled steak with a savory crust. Tender and flavorful!"/>
                <MenuCard image={Vegetarianpizza} name="Vegetarian Pizza" price="$20.50" description="Fresh vegetables, mozzarella, and tangy tomato sauce on a crispy crust. Flavorful and satisfying!"/>
            </section>
